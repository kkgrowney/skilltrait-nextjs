    ...
    <aside className="bg-[#1F2327] w-[54px] h-screen fixed left-0 top-0 flex flex-col justify-between border-r border-[#454446]">
      ...
      <div className="flex flex-col gap-2 p-3">
        ...
        <nav className="flex flex-col gap-2 items-center">
          ...
          <div className="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-[#202327]">
            <img 
              src="/company.svg" 
              alt="Companies" 
              className="h-5 w-5"
      ...
      <div className="p-3 mt-auto mb-6">
        <button 
          onClick={toggleCollapsed}
          className="w-full flex items-center justify-center p-2 rounded-lg hover:bg-[#202327]"
        >
          <img 
