      ...
      <div className="mt-6">
        ...
        <div className="flex justify-center gap-3 mb-4">
          ...
          <button
            type="button"
            disabled={!isLoggedIn}
            className="disabled:opacity-50 p-3 rounded-full bg-gray-600 hover:bg-gray-500 transition-colors flex items-center justify-center"
            aria-label="Copy"
          >
            <svg
              width="24"
          ...
          <button
            type="button"
            disabled={!isLoggedIn}
            className="disabled:opacity-50 p-3 rounded-full bg-[#0077B5] hover:bg-[#005885] transition-colors"
          ...
          <button
            type="button"
            disabled={!isLoggedIn}
            className="disabled:opacity-50 p-3 rounded-full bg-black hover:bg-gray-800 transition-colors"
          ...
          <button
            type="button"
            disabled={!isLoggedIn}
            className="disabled:opacity-50 p-3 rounded-full bg-[#1877F2] hover:bg-[#166FE5] transition-colors"
