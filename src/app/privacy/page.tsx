...
export default function Privacy() {
  useEffect(() => {
    ...
    const hideNavigation = () => {
      ...
      const existingStyle = document.getElementById('privacy-nav-hide');
      if (existingStyle) {
    ...
    return () => {
      ...
      observer.disconnect();
      const style = document.getElementById('privacy-nav-hide');
  ...
  return (
    <iframe 
      src="/skill-trait-webflow/privacy.html"
      title="SkillTrait: Privacy"
