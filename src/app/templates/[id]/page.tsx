              ...
              <div className="bg-[#212327] rounded-lg shadow-sm border border-[#454446] p-4 mx-auto" style={{ maxWidth: "600px" }}>
                ...
                <div className="flex flex-wrap justify-center gap-3 mb-2 sm:gap-4 md:gap-5">
                  {[
                    ...
                    { label: "Download", bg: "bg-gray-600 hover:bg-gray-500", icon: <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" />, onClick: () => downloadTemplateUtil(template.backgroundUrl || "/liquid_death_props.png", template.company) },
