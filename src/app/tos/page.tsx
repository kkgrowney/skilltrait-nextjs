...
export default function TermsOfService() {
  useEffect(() => {
    ...
    const hideNavigation = () => {
      ...
      const existingStyle = document.getElementById('tos-nav-hide');
      if (existingStyle) {
    ...
    return () => {
      ...
      observer.disconnect();
      const style = document.getElementById('tos-nav-hide');
  ...
  return (
    <iframe 
      src="/skill-trait-webflow/skilltrait-terms-of-service.html"
      title="SkillTrait: Terms of Service"
