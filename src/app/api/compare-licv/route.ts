  ...
  try {
    ...
    if (!resumeText) {
      ...
      return NextResponse.json(
        {
          error:
            "Resume text is required. Please copy and paste the text from your PDF manually.",
        },
        { status: 400 }
      );
    }
      ...
      messages: [
        {
          role: "system",
          content:
            "You are an expert HR professional and resume analyst. Provide detailed, professional analysis of resume and LinkedIn profile consistency.",
        },
        {
          role: "user",
          content: prompt,
