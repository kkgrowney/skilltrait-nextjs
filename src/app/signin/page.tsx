            ...
            <div className="flex flex-col gap-6 items-start justify-start max-w-[360px] p-0 relative shrink-0 w-full" style={{marginTop: '80px'}}>
              <div className="flex flex-col gap-2 items-start justify-start leading-[0] p-0 relative shrink-0 text-center w-full">
                ...
                <div className="font-normal relative shrink-0 text-[14px] text-gray-300 w-full">
                  <p className="block leading-[20px]">Log in to unlock tailored content and stay connected with your community.</p>
                </div>
              </div>
              ...
              <form onSubmit={handleEmailSignIn} className="flex flex-col gap-4 items-start justify-start p-0 relative shrink-0 w-full">
                <div className="flex flex-col gap-2 items-start justify-start p-0 relative shrink-0 w-full">
                  <input
                    type="email"
                    placeholder="Email"
                ...
                <div className="flex flex-row items-center justify-between p-0 relative shrink-0 w-full">
                  ...
                  >
                    <div className={`relative rounded shrink-0 size-4 border ${rememberMe ? 'bg-green-500' : 'bg-transparent'}`} style={{borderColor: '#454446'}}></div>
                    <span className="font-medium text-[14px] text-white">Remember me</span>
                  </button>
                  <a href="/forgot-password" className="font-normal text-[14px] text-gray-400 underline hover:text-gray-300">Forgot password?</a>
                </div>
